...
def pl_manara(request):
    ...
    #
    cursor.execute("SELECT * FROM [dbo].[AscenderData_Manara];") 
    rows = cursor.fetchall()
    ...
    return render(request,'dashboard/manara/pl_manara.html', context)


def bs_manara(request):
    ...
    return render(request,'dashboard/manara/bs_manara.html', context)